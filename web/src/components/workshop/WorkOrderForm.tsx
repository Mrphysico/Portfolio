...
import { Send, CheckCircle2, Wrench, Sparkles, Github, Linkedin, ExternalLink } from 'lucide-react';
...
export const WorkOrderForm: React.FC<WorkOrderFormProps> = ({
  ...
  return (
    <div className="w-full max-w-lg mx-auto lg:mx-0 flex flex-col gap-4 relative z-10 font-sans">
      {/* ================= ARTH'S SPEECH BUBBLE ================= */}
      <div
        className="relative bg-zinc-900/90 backdrop-blur-md border border-cyan-500/40 rounded-xl p-3.5 shadow-[0_0_20px_rgba(0,247,255,0.15)] flex items-start gap-3 transition-all duration-300"
        aria-live="polite"
      >
        <div className="w-8 h-8 rounded-full bg-cyan-500/20 border border-cyan-400 flex items-center justify-center shrink-0 text-cyan-300 text-xs font-mono font-bold">
          AJ
        </div>
      ...
      <div className="bg-zinc-950/85 backdrop-blur-xl border border-zinc-800/80 rounded-2xl p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-mono font-medium flex items-center gap-1.5 transition-all ${
              isBooted
                ...
                : 'bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 hover:border-cyan-400 text-zinc-300 hover:text-cyan-300 active:scale-95'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-mono font-medium flex items-center gap-1.5 transition-all ${
              isAntiG
                ? 'bg-cyan-500/20 border border-cyan-400 text-cyan-300 shadow-[0_0_10px_rgba(0,247,255,0.3)]'
                : 'bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 hover:border-cyan-400 text-zinc-300 hover:text-cyan-300 active:scale-95'
            }`}
          >
